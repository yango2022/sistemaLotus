	...
	public function salvar() {
		...
		if($this->aluno->procuraRegistroExistente('alunos', null, 'inep', $this->input->post('inep'))->result()){
            $dados = array(
                ...
                'alunos'      	=> $this->aluno->selecionaTudo('alunos')->result(),
	        ...
	        $data = array(
	            ...
	            'certidao'     					=> $this->input->post('certidao'),
	            'certidao_matricula'            => $this->input->post('certidao_matricula'),
	            'certidao_termo'            	=> $this->input->post('certidao_termo'),
	            'certidao_livro'            	=> $this->input->post('certidao_livro'),
	            'certidao_folha'            	=> $this->input->post('certidao_folha'),
		    ...
		    $dados = array(
		        ...
		        'contents'      => 'aluno/listar',
		        'alunos'      	=> $this->aluno->selecionaPorAtributo('alunos','escola_id', $this->session->userdata('usuario_escola'))->result(),
		        'tipo'          => 'table'
		    );
		}
