                        ...
                        <div class="box-body">
                            <div class='row'>
                                <div class="form-group col-sm-3">
                                    <label>Código da Escola INEP</label>
                                    <input type="text" required name="inep" class="form-control" placeholder="Digite o código INEP da Escola">
                                </div>
                            ...
                            <div class='row'>
                                ...
                                <div class="form-group col-sm-2">
                                    ...
                                    <input type="text" required name="telefone" class="form-control" placeholder="Telefone">
                                </div>
                                <div class="form-group col-sm-3">
                                ...
                                <div class="form-group col-sm-3">
                                    ...
                                    <input type="text" required name="cpf_diretor" class="form-control" placeholder="CPF do(a) Diretor(a)">
                                </div>
                            </div>
                            <div class='row'>
                                <div class="col-lg-3">
