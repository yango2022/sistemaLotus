    ...
    <section class="invoice" style="text-align: center">
        ...
        <div class="row" >
            <div class="col-xs-12">
                <h1 class="page-header">
                    <strong>Declaração de Matrícula</strong>
                </h1>
            </div>
            <br>
        ...
        <div class="row invoice-info">
            <div class="col-sm-12">
                <address>
                    <strong>
                        Declaro para os devidos fins que, <?php echo $aluno[0]->nome; ?>, nascido(a) no dia  <?php echo date('d/m/Y',  strtotime($aluno[0]->data_nascimento)) ?>, natural da cidade de <?php echo $aluno[0]->naturalidade; ?>, <?php echo $aluno[0]->uf_naturalidade; ?>,filho de  <?php echo $aluno[0]->mae; ?> e de  <?php echo $aluno[0]->pai; ?>, está matrículado(a) na referida escola  e irá cursar ano  <?php echo $turma[0]->nome; ?>, no turno da  <?php echo $turma[0]->turno; ?>, no ano  <?php echo $matricula[0]->ano; ?>.
                    </strong>
                </address>
